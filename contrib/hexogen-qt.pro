...
RESOURCES += src/qt/hexogen.qrc src/qt/hexogen_locale.qrc

TRANSLATIONS += src/qt/locale/hexogen_bg.ts \
                src/qt/locale/hexogen_de.ts \
                src/qt/locale/hexogen_en.ts \
                src/qt/locale/hexogen_es.ts \
                src/qt/locale/hexogen_fi.ts \
                src/qt/locale/hexogen_fr.ts \
                src/qt/locale/hexogen_it.ts \
                src/qt/locale/hexogen_ja.ts \
                src/qt/locale/hexogen_pl.ts \
                src/qt/locale/hexogen_pt.ts \
                src/qt/locale/hexogen_ru.ts \
                src/qt/locale/hexogen_sk.ts \
                src/qt/locale/hexogen_sv.ts \
                src/qt/locale/hexogen_vi.ts \
                src/qt/locale/hexogen_zh_CN.ts \
                src/qt/locale/hexogen_zh_TW.ts
