Contributing to Hexogen Core
============================

The Hexogen Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/hexogen-project/hexogen/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Hexogen Core project, and is not to be
confused with overall Hexogen Network Protocol consensus changes.

Whether a pull request is merged into Hexogen Core rests with the project merge
...
Patches that change Hexogen consensus rules are considerably more involved than
...
Where a patchset proposes to change the Hexogen consensus, it must have been
...
The project leader is the release manager for each Hexogen Core release.
