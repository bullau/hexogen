...
from fake_stake.base_test import Hexogen_FakeStakeTest

class zHXGwrappedSerialsTest(Hexogen_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zHXGs..." % DENOM_TO_USE)
