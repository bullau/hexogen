...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Hexogen Core hexogen-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hexogen-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hexogen transaction") + "\n" +
                               "  hexogen-tx [options] -create [commands]   " + _("Create hex-encoded hexogen transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hexogen transaction
