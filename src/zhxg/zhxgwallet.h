...
#ifndef Hexogen_ZHXGWALLET_H
#define Hexogen_ZHXGWALLET_H
...
public:
    CzHXGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZHXG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZHXG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
