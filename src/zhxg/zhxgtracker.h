...
#ifndef Hexogen_ZHXGTRACKER_H
#define Hexogen_ZHXGTRACKER_H
...
public:
    CzHXGTracker(std::string strWalletFile);
    ~CzHXGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzHXGWallet* zHXGWallet = NULL);
