...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Hexogen server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Hexogen features */
        {"hexogen", "listmasternodes", &listmasternodes, true, true, false},
        {"hexogen", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hexogen", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hexogen", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"hexogen", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"hexogen", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"hexogen", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hexogen", "masternodedebug", &masternodedebug, true, true, false},
        {"hexogen", "startmasternode", &startmasternode, true, true, false},
        {"hexogen", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hexogen", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hexogen", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hexogen", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hexogen", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hexogen", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hexogen", "preparebudget", &preparebudget, true, true, false},
        {"hexogen", "submitbudget", &submitbudget, true, true, false},
        {"hexogen", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hexogen", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hexogen", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hexogen", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hexogen", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hexogen", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hexogen", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hexogen", "checkbudgets", &checkbudgets, true, true, false},
        {"hexogen", "mnsync", &mnsync, true, true, false},
        {"hexogen", "spork", &spork, true, true, false},
        {"hexogen", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzhxgseed", &getzhxgseed, false, false, true},
        {"zerocoin", "setzhxgseed", &setzhxgseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzhxg", &searchdzhxg, false, false, true},
        {"zerocoin", "dzhxgstate", &dzhxgstate, false, false, true},
...
{
    return "> hexogen-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:35495/\n";
}
