...
/**
 * Hexogen RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZhxgSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzhxgseed(const UniValue& params, bool fHelp);
extern UniValue getzhxgseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzhxg(const UniValue& params, bool fHelp);
extern UniValue dzhxgstate(const UniValue& params, bool fHelp);
