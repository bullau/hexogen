...
/** Utility functions used by the Hexogen Qt UI.
 */
namespace GUIUtil
{
...
// Render Hexogen addresses in monospace font
...
// Parse "hexogen:" URI into recipient object, return true on successful parsing
