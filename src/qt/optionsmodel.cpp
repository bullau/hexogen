...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::HXG);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeHexogenAmount"))
        SoftSetArg("-anonymizehexogenamount", settings.value("nAnonymizeHexogenAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in hexogen.cpp during shotdown to also remove the window positions
