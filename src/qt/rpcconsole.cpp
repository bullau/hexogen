                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzHXGPathCustom = GetArg("-zhxgbackuppath", "");
    ...
    if(!strzHXGPathCustom.empty()) {
        ui->wallet_customzhxgbackuppath->setText(QString::fromStdString(strzHXGPathCustom));
        ui->wallet_customzhxgbackuppath_label->setVisible(true);
        ui->wallet_customzhxgbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzHXGPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Hexogen RPC console.") + "<br>" +
