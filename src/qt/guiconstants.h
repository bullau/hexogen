...
/* Hexogen GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Hexogen"
#define QAPP_ORG_DOMAIN "hexogen.org"
#define QAPP_APP_NAME_DEFAULT "Hexogen-Qt"
#define QAPP_APP_NAME_TESTNET "Hexogen-Qt-testnet"
